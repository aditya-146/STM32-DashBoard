...
/* Definitions for TempHumiSensor */
osThreadId_t TempHumiSensorHandle;
const osThreadAttr_t TempHumiSensor_attributes = {
  .name = "TempHumiSensor",
  .stack_size = 1024 * 4,
...
/* USER CODE BEGIN Header_SpeedBtnsTask */
/**
  * @brief  Function implementing the SpeedBtns thread.
...
/* USER CODE BEGIN Header_TempHumiTask */
/**
* @brief Function implementing the TempHumiSensor thread.
* @param argument: Not used
* @retval None
*/
